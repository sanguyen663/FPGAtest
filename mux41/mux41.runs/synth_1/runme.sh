...
HD_PWD='C:/Users/VICTUS/Desktop/FPGAtest/mux41/mux41.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log mux_4to1_case.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source mux_4to1_case.tcl
