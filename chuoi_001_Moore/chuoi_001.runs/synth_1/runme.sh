...
HD_PWD='C:/TaiLieuHocTap/Nam3k2/FPGA/chuoi_001_Moore/chuoi_001.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log chuoi.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source chuoi.tcl
