...
HD_PWD='C:/Users/VICTUS/Desktop/FPGAtest/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log counter_5_to_100.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source counter_5_to_100.tcl
