...
HD_PWD='C:/TaiLieuHocTap/Nam3k2/FPGA/I2C/I2C.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log i2c_lcd_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source i2c_lcd_top.tcl
