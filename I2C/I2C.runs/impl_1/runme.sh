...
HD_PWD='C:/TaiLieuHocTap/Nam3k2/FPGA/I2C/I2C.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log i2c_lcd_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source i2c_lcd_top.tcl -notrace
