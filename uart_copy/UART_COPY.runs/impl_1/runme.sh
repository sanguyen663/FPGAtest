...
HD_PWD='C:/TaiLieuHocTap/Nam3k2/FPGA/uart_copy/UART_COPY.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log uart_led_controller.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source uart_led_controller.tcl -notrace
