...
HD_PWD='C:/TaiLieuHocTap/Nam3k2/FPGA/uart_copy/UART_COPY.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log uart_led_controller.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source uart_led_controller.tcl
