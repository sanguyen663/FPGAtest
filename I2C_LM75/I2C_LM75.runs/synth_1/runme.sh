...
HD_PWD='C:/TaiLieuHocTap/Nam3k2/FPGA/I2C_LM75/I2C_LM75.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log i2c_read_lm75.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source i2c_read_lm75.tcl
