...
HD_PWD='C:/TaiLieuHocTap/Nam3k2/FPGA/I2C_LM75/I2C_LM75.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log i2c_read_lm75.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source i2c_read_lm75.tcl -notrace
