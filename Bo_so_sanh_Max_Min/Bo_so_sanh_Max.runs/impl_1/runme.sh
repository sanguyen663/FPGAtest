...
HD_PWD='C:/Users/VICTUS/Desktop/FPGAtest/Bo_so_sanh_Max_Min/Bo_so_sanh_Max.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log max.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source max.tcl -notrace
