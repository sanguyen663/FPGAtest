...
synth_design -top max -part xc7a35tfgg484-2


# disable binary constraint mode for synth run checkpoints
set_param constraints.enableBinaryConstraints false
write_checkpoint -force -noxdef max.dcp
create_report "synth_1_synth_report_utilization_0" "report_utilization -file max_utilization_synth.rpt -pb max_utilization_synth.pb"
