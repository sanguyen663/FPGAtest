...
HD_PWD='C:/TaiLieuHocTap/Nam3k2/FPGA/nt2ss/project_2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log nt2ss_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source nt2ss_top.tcl
