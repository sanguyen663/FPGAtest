...
HD_PWD='C:/TaiLieuHocTap/Nam3k2/FPGA/nt2ss/project_2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log nt2ss_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source nt2ss_top.tcl -notrace
